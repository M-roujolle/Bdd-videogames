...
<body>
    ...
    <div class="principalepict">
        <!-- navabar-------------------------------------------------------------- -->
        <nav class="navbar navbar-expand-lg navbar-light bg-dark mb-5 pt-2 pb-2">
        ...
        <div class="card text-center colorbg text-white mb-5 ms-5 me-5 mt-5">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link bg-white  border border-white" aria-current="true" href="home.php"><?= $value->Jeu ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link bg-success text-white  border border-white" href="./more.php">Synopsis</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <h5 class="card-title"><?= $value->Jeu ?></h5>
                <p class="card-text pt-5 mb-5"><?= $value->Descriptif ?></p>
            </div>
        </div>
